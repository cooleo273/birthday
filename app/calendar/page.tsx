...
export default function CalendarPage() {
    ...
    return (
        <main className={cn("min-h-screen pt-16 pb-32 relative overflow-hidden bg-gradient-to-br transition-colors duration-1000", theme.gradient)}>
            ...
            <div className="max-w-4xl mx-auto px-4 mb-14 text-center relative z-10">
                <Link href="/" className={cn("inline-flex items-center gap-2 transition-colors mb-10 group opacity-40 hover:opacity-100", theme.textColor)}>
                ...
                <motion.p
                    ...
                    className={cn("text-base max-w-lg mx-auto", theme.textColor)}
                >
